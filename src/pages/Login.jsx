...
const Login = () => {
  ...
  return (
    ...
    >
      <div
        className={`bg-gradient-to-br from-[#0a0e27] via-[#1a1347] to-[#0d0221] flex flex-col items-center relative border border-purple-500/20 ${
          isExtension
            ? "w-full h-full rounded-none py-4 px-5 justify-center overflow-hidden"
            : "w-[360px] h-[600px] rounded-3xl justify-center overflow-hidden shadow-[0_0_40px_rgba(139,92,246,0.4)]"
        }`}
      >
        ...
        {/* Glass card with enhanced backdrop */}
        <div
          className={`relative z-10 bg-gradient-to-br from-white/[0.12] to-white/[0.05] backdrop-blur-2xl border border-white/[0.18] rounded-2xl shadow-[0_8px_32px_0_rgba(139,92,246,0.2)] ${
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className={`relative bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 hover:rotate-6 ${
            ...
            <h1
              className={`font-bold bg-gradient-to-r from-white via-purple-200 to-blue-200 bg-clip-text text-transparent tracking-tight ${
            ...
            <p
              className={`text-gray-300/90 tracking-wide font-light ${
          ...
          <div className={isExtension ? "space-y-3" : "space-y-5"}>
            {error && (
              <div
                className={`bg-gradient-to-r from-red-500/10 to-pink-500/10 border border-red-400/40 rounded-xl text-red-200 text-center backdrop-blur-sm ${
            ...
            <div className={isExtension ? "space-y-1.5" : "space-y-2"}>
              ...
              <input
                ...
                className={`w-full bg-slate-900/60 border border-slate-600/40 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 outline-none transition-all duration-200 hover:border-slate-500/60 ${
            ...
            <div className={isExtension ? "space-y-1.5" : "space-y-2"}>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-slate-900/60 border border-slate-600/40 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 outline-none transition-all duration-200 hover:border-slate-500/60 pr-10 ${
                    isExtension ? "px-3 py-2 text-xs" : "px-4 py-3 text-sm"
                  }`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white transition-colors p-1 rounded-lg hover:bg-white/5"
                >
            ...
            <div className="text-center">
              <Link
                to="/register"
                className={`text-purple-400 hover:text-purple-300 font-medium inline-flex items-center space-x-2 transition-all duration-200 hover:translate-x-1 group ${
                  isExtension ? "text-xs" : "text-sm"
                }`}
              >
                <span>Create New Wallet</span>
